...
void iniciarJuego() {
  ...
  //Puñete
  FCircle puno = new FCircle(70);
  //puño.setPosition(546, 195);
  puno.setPosition(526, 195);
  puno.attachImage(punito);
  puno.setRotatable(false);
  mundo.add(puno);

  FDistanceJoint cadena = new FDistanceJoint(eje, puno);
  ...
  boton.inicializar (width/2, height/2);
  boton.setFill(254, 26, 255);
  mundo.add(boton);
}
                  ...
                  if (mouseX > 897 - 30/2 && mouseX < 897+30/2
                    ...
                    if (mouseX > 163 - 60/2 && mouseX < 163+60/2
                      ...
                      if (mouseX > 1290 - 30/2 && mouseX < 1290+30/2
                        ...
                        if (mouseX > width/2 - 60/2 && mouseX <  width/2 + 60/2
                          && mouseY > height/2 - 60/2 && mouseY < height/2+60/2) {
                          perder();
                          pop.play();
                          pop.amp(0.2);
                        }

...
//
Hamster hamster;
Plataforma base1, base2, base3, base4, base6, base7, base8, base11, baseDeInicio, boton;
...
void setup() {
  ...
  libPunete = loadImage("liberarpuñete.png");
...
void inicio_() {
  ...
  hamster = new Hamster(300);
  hamster.inicializar(width/2, 400);
  mundo.add(hamster);
  baseDeInicio = new Plataforma(250, 60);

  baseDeInicio.inicializar (width/2, 500);
  baseDeInicio.setGrabbable(true);
  //baseDeInicio.attachImage(platMov);
  mundo.add(baseDeInicio);
...
void contactStarted(FContact contact) {
  ...
  else if ((_cuerpo1.getName() == "hamster" && _cuerpo2.getName() == "SemiIni")
    || (_cuerpo2.getName() == "hamster" && (_cuerpo1.getName() == "SemiIni" ))) {
    if (hamster.vivo) {
